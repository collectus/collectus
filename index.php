...
<!--End of Zopim Live Chat Script-->
	...
	<title>Collectus - Evacuation d'archives et matériels bureautiques : déchets informatiques DEEE, destruction de papiers archives - revalorisation </title>
...
<div id="conteneur">
	...
	<div id="imagecentrale">
			<img src="images/collectus_destruction_collecte_dechets.png" width=1000 height=250 />
	</div>
	<br>
		...
		<div id="index_centre_accueil" >	
			...
			<div id="head_title">
			<span>Spécialiste en évacuation de matériels et déchets</span>
			</div>
			<div id="accueil_title">
			"Le recyclage et le tri au coeur de notre service"
			</div>	
				<br>
				<br>
				<br>
			...
			<div id="services">
					...
					<a href="recycle-besoinponctuel-destruction.html" class="service_link">
					<div class="services" id="inventaire">
					<span class="services_title">Tertaire</span>
					<span class="services_subtitle">bureautique</span>
					<img src="images/otoblue.png" width="100%" /><span class="services_offres"></span><br/>
					<span class="services_offres">Besoins ponctuels ou réguliers ?<br> Collect'us permet d'évacuer vos déchets<br> et détruire vos archives et matériels informatiques confidentiels<br></span>
						...
						<a a class="ensavoirplusaccueil" href="recycle-besoinponctuel-destruction.html" id="savoir_plus_3">ARCHIVES & BUREAUTIQUE<!--, faites un inventaire--></a><br><br>
						
						<a a class="ensavoirplusaccueil" href="recycle-besoinponctuel-tracabilite.html" id="savoir_plus_3">CERTIFICAT et TRACABILITE<!--,REDUIRE SES FACTURES faites un inventaire--></a><br><br>
						<!--<a a class="ensavoirplusaccueil" href="devis.php" id="savoir_plus_3">FAIRE SON INVENTAIRE</a><br><br>-->
					...
					<a href="recycle-besoinmaintenance-volumineux.html" class="service_link">
					<div class="services" id="recurrent">
					<span class="services_title">Industriel</span>
					<span class="services_subtitle"> matériel lourd</span>
					<img src="images/otoblue.png" width="100%" /><span class="services_offres"></span><br/>
					<span class="services_offres">Des équipes spécialisées dans la planification des opérations : Desinstallation, démantellement, transport, traitement </span>
						<div class="services_fleche">
									
						<br>
						</div>
						<a class="ensavoirplusaccueil" href="recycle-besoinmaintenance-volumineux.html"; " id="savoir_plus_1">EQUIPEMENTS VOLUMINEUX<!--, contacter nous--></a><br><br>
						
					<a class="ensavoirplusaccueil" href="recycle-besoinmaintenance-processus.html"; " id="savoir_plus_1">PROCEDURE D'INTERVENTION<!--, contacter nous--></a><br><br>
						<!--<a class="ensavoirplusaccueil" href="prestation-presta-securite.html"; " id="savoir_plus_1">UN SERVICE COMPLET</a><br><br>-->
					...
					<img src="images/otoblue.png" width="100%" /><span class="services_offres"></span><br/>
					<span class="services_offres">Collect'us réalise des études et met son experience au service d'une approche environnementale selon vos objéctifs.</span>
						<div class="services_fleche">
						
						
						<br>
						</div>
						<a  a class="ensavoirplusaccueil" href="recycle-besoinconseil-auditenvironnementale.html"; " id="savoir_plus_2">AUDIT</a><br><br>
						<a  a class="ensavoirplusaccueil" href="recycle-besoinconseil-accompagner.html"; " id="savoir_plus_2">ACCOMPAGNEMENET</a><br><br>
						<a  a class="ensavoirplusaccueil" href="recycle-besoinconseil-performance.html"; " id="savoir_plus_2">PERFORMANCE</a><br><br>
						<img src="images/otoblue.png" width="100%" /><span class="services_offres"></span><br/>
					</div>
					</a>-->
				...
				<span style="font-weight:;color:rgb(80,80,80);font-size:15px"><u><strong>CE QUE NOUS COLLECTONS</strong></u></span>
				</div>-->
				...
				<table>
				<tr style="text-align:left">
					<td style="padding-bottom:40px"><a href="presentation-premierepage-collectons.html"><img class="arrondie" src="./images/collectus_materiel_informatique_deee.png"/></a></td>
					<td id="cellule_1" style="padding-left:15px">
						<a class="cd" href="presentation-premierepage-collectons.html">INFORMATIQUE et DEEE</a><br>
						<a class="dd" href="presentation-premierepage-collectons.html">PC, imprimante, écran, serveur, collecte deee, recyclage ordinateur, DEEE</a>
					</td>
					
					
					
					<td style="padding:0px 0px 0px 45px"><a href="presentation-premierepage-collectons.html"><img class="arrondie" src="./images/collectus_destruction_archives_papier.png" width="100%"/></a></td>
					<td id="cellule_1" style="padding-left:15px">
						<a class="cd" href="presentation-premierepage-collectons.html">PAPIER et ARCHIVE</a><br>
						<a class="dd" href="presentation-premierepage-collectons.html">Papier, archives et carton</a>
					</td>	
				...
				<tr>
					...
					<td style="padding-bottom:40px"><a href="presentation-premierepage-collectons.html"><img class="arrondie" src="./images/picto_encombrant_new.png"/></a></td>
					<td id="cellule_1" style="padding-left:15px">
						<a class="cd" href="presentation-premierepage-collectons.html">MOBILIER DE BUREAU</a><br>
						<a class="dd" href="presentation-premierepage-collectons.html">Chaise, Bureau, et autre équipement mobilier</a>
					</td>
					<td style="padding:0px 0px 0px 45px"><a href="presentation-premierepage-collectons.html"><img class="arrondie" src="./images/picto_secure_new.png"/></a></td>
					<td id="cellule_1" style="padding-left:15px">
						<a class="cd" href="presentation-premierepage-collectons.html">DESTRUCTION SUPPORT CONFIDENTIEL</a><br>
						<a class="dd" href="presentation-premierepage-collectons.html">Désarchivage, destruction d'archives, données confidentielles, disque dur, cd... </a>
					</td>
					
				
				</tr> 
				<tr>
					<td style="padding-bottom:40px"><a href="presentation-premierepage-collectons.html"><img class="arrondie" src="./images/machine-outils-industrielle.png" width="100%"/></a></td>
					<td id="cellule_1" style="padding-left:15px">
						<a class="cd" href="presentation-premierepage-collectons.html">MACHINERIE LOURDE</a><br>
						<a class="dd" href="presentation-premierepage-collectons.html">Machines outils industrielles, IRM médical, Datacenter...</a>
					</td>
					
					<td style="padding:0px 0px 0px 45px"><a href="presentation-premierepage-collectons.html"><img class="arrondie" src="./images/collectus_cartouche_toner.png"/></a></td>
					<td id="cellule_1" style="padding-left:15px">
						<a class="cd" href="presentation-premierepage-collectons.html">CONSOMMABLES</a><br>
						<a class="dd" href="presentation-premierepage-collectons.html">Cartouches jet d'encre, toners, piles...</a>
					</td>	
				...
				<div class="partenaire1">
					<div class="underline">
						<span class="partner">NOS PARTENAIRES RECYCLEURS</span>
						<img src="images/traitement-recyclage-recuperation.png" alt="partenaire-traitement-recyclage-recuperation-dechets" width=100% />
					</div>
				</div>
				<div class="partenaire2">
				<span class="easy-recycle">LE RECYCLAGE FACILE</span>
				Située au centre de Paris et <strong>agréée par la préfecture</strong>, COLLECTUS est un organisme de collecte, débarras, évacuation et recyclage des déchets d'entreprise : électriques, informatiques DEEE / D3E, consommables, destruction papiers, archives, matériel de bureau etc.
				<br>
				Dans une optique de développement durable nous accompagnons les sociétés pour gérér, sécuriser, et recycler leur matériel usagé dans le respect des règlementations en vigueur - traçabilité et délivrance de bordereaux de suivi BSD.
				<br>
				Spécialisée dans la récupération, l'évacuation, la destruction et la mise en place de solution de tri et conditionnement, nos équipes interviennent rapidement sur site et dans les étages.</div>
			</div>
