...
<div id="conteneur">
	...
	<div id="imagecentrale">
			<img src="images/collectus_recyclage_informatique.png" width=1000 height=250 />
	</div>
		...
		<div id="index_centre_accueil" >	
			...
			<div id="head_title">
			<span>Recyclage et destruction de déchets bureautiques</span>
			</div>
			<div id="accueil_title">
			&nbsp&nbsp&nbsp&nbsp"Un interlocuteur unique quelques soient vos déchets"
			</div>	
				<br>
				<br>
				<br>
				...
				<div id="pricer_title2">
					...
					Gestion et destruction de matériel informatique
					</div><br><br><br>
				...
				<a class="service_link">
					...
					<span class="services_offres2"><img src="images/fleche_inscription.png" /> &nbspOptimisation de vos espaces <br><br><img src="images/fleche_inscription.png" /> &nbspDebarrassage du matériel obsolète <br><br><img src="images/fleche_inscription.png" /> &nbspDestruction de données stockées</span>
					...
					<img src="images/otogreen.png" width="100%" /><span class="services_offres"></span><br/>
					<span class="services_offres2"><img src="images/fleche_inscription.png" /> &nbspAccompagnement et conseil<br><br><img src="images/fleche_inscription.png" /> &nbspSolution dédiée et personnalisée<br><br><img src="images/fleche_inscription.png" /> &nbspDestruction de données personnelles</span>
						<div class="services_fleche">
				...
				<tr style="text-align:left">
					...
					<td id="cellule_1" style="padding-left:15px">
						...
						<a class="dd" href="prestation-presta-assistance.html">Ordinateur, imprimante, écran, serveur, moniteur, téléphone mobile, onduleur etc.</a>
					</td>
					...
					<td id="cellule_1" style="padding-left:15px">
						...
						<a class="dd" href="prestation-presta-securite.html">Destruction de vos disques et stockages pour une protection de vos informations.</a>
					</td>	
				...
				<tr>
					...
					<td id="cellule_1" style="padding-left:15px">
						...
						<a class="dd" href="prestation-presta-suivi.html">Certificats de Destruction, Bordereau de Suivi de Déchets délivré après la collecte. </a>
					</td>
				...
				Située au centre de Paris et <strong>agréée par la préfecture</strong>, COLLECT'US SARL est un organisme de collecte et recyclage des déchets d'entreprise : matériel électriques, matériel informatiques DEEE / D3E, consommables, récupération papiers, destruction des archives, etc.
				<br>
				Dans une optique de développement durable nous accompagnons les sociétés pour gérér, sécuriser et recycler leur matériel usagé dans le respect des règlementations en vigueur - traçabilité et délivrance de bordereaux de suivi de déchets BSD.
				<br>
