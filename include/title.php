<?php
	...
	if($menu == "premierepage")
	{
		...
		elseif($page == "bascout")
		{
			echo '<h2>Réduire ses factures avec Collectus</h2>';
		}
		elseif($page == "bordereau")
		{
			echo '<h2>Service Sécurisé</h2>';
		}
		elseif($page == "efficace")
		{
			echo '<h2>Service Simple et Rapide</h2>';
		}
		elseif($page == "equipe")
		{
	...
	if($menu == "secondepage")
	{
		...
		{
			echo '<h2>Dernières réalisations</h2>';
		}
		
		elseif($page == "equipe")
		{
			echo '<h2>Le recyclage au coeur de notre activité</h2>';
		}
		elseif($page == "certif")
		{
	...
	elseif($menu == "besoinponctuel")
	{
		...
		{
			echo '<h2>Certificats et traçabilité</h2>';
		}		
		elseif($page == "adherent")
		{
			echo '<h2>Choisir Collectus ?</h2>';
		}
		elseif($page == "urne")
		{
			echo '<h2>Des outils spécialisés pour la collecte</h2>';
		}
		elseif($page == "destruction")
		{
			echo '<h2>Archives et bureautique</h2>';
		}
		elseif($page == "complete")
		{
			echo '<h2>Un service complet</h2>';
		}
		elseif($page == "option")
		{
	...
	elseif($menu == "besoinmaintenance")
	{
		...
		{
			echo '<h2>Desinstallation d\'équipements volumineux</h2>';
		}
		elseif($page == "demantelement")
		{
			echo '<h2>Nos interventions</h2>';
		}
		elseif($page == "processus")
		{
			echo '<h2>Procedure d\'intervention</h2>';
		}
		elseif($page == "complete")
		{
			echo '<h2>Un service complet</h2>';
	...
	elseif($menu == "recuperation")
	{
		...
		{
			echo '<h2>Secteur tertiaire</h2>';
		}
		elseif($page == "industries")
		{
			echo '<h2>Secteur industriel</h2>';
		}
		elseif($page == "demenagement")
		{
			echo '<h2>Déménagement d\'entreprise</h2>';
		}
		elseif($page == "fonds")
		{
			echo '<h2>Secteur financier</h2>';
		}
		elseif($page == "juridique")
		{
			echo '<h2>Secteur juridique</h2>';
		}
		elseif($page == "medical")
		{
			echo '<h2>Secteur médical</h2>';
		}
		elseif($page == "salons")
		{
			echo '<h2> <br></h2>';
		...
		{
			echo '<h2>Secteur administratif</h2>';
		}
		...
		{
			echo '<h2>Secteur informatique</h2>';
		}
		elseif($page == "nettoyage")
		{
			echo '<h2>Secteur du facility et entretien</h2>';
		}
