<?php
	...
	elseif($menu == "besoinmaintenance")
	{
		...
		if($page == "maintenance")
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Offres&nbsp;&nbsp;>&nbsp;&nbsp;Service de maintenance';
		}
		elseif($page == "audit")
		{
		...
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Offres&nbsp;&nbsp;>&nbsp;&nbsp;Service maintenance&nbsp;&nbsp;>&nbsp;&nbsp;Choisir Collect\'us';
		}
		elseif($page == "urne")
		{
	...
	elseif($menu == "premierepage")
	{
		if($page == "collectons")
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Collect\'us&nbsp;&nbsp;>&nbsp;&nbsp;Un service complet';
		}
		
		elseif($page == "equipe")
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Collect\'us&nbsp;&nbsp;>&nbsp;&nbsp;La société';
		}
		elseif($page == "certif")
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Collect\'us&nbsp;&nbsp;>&nbsp;&nbsp;Certification';
		}
		elseif($page == "documents")
		{
				echo '&nbsp;&nbsp;>&nbsp;&nbsp;Collect\'us&nbsp;&nbsp;>&nbsp;&nbsp;Documentation';
		}
		elseif($page == "landingdeee")
		{
				echo '&nbsp;&nbsp;>&nbsp;&nbsp;Collect\'us&nbsp;&nbsp;>&nbsp;&nbsp;Enlèvement des DEEE';
		}
		elseif($page == "landingpapier")
		{
				echo '&nbsp;&nbsp;>&nbsp;&nbsp;Collect\'us&nbsp;&nbsp;>&nbsp;&nbsp;Recyclage du Papier';
		}
	...
	elseif($menu == "presta")
	{
		if($page == "collectons")
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Collect\'us&nbsp;&nbsp;>&nbsp;&nbsp;Nous collectons...';
		}
	...
	elseif($menu == "recuperation")
	{
		...
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Service&nbsp;&nbsp;>&nbsp;&nbsp;Prestataire informatique';
		}
		elseif($page == "nettoyage")
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Service&nbsp;&nbsp;>&nbsp;&nbsp;Société de nettoyage';
		}
		...
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Service&nbsp;&nbsp;>&nbsp;&nbsp;Administration et Ecole';
		}
		elseif($page == "facilitymanagement")
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Service&nbsp;&nbsp;>&nbsp;&nbsp;Société de facility management';
		}
		else
		{
			echo '&nbsp;&nbsp;>&nbsp;&nbsp;Service&nbsp;&nbsp;>';
